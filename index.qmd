...
if kelly_fraction > 0:
    ...
    print(f"  ✓ Both strategies (100% and 50%) bet more than the Kelly optimal.")
    print(f"  ✓ Over-betting relative to Kelly increases volatility and risk of ruin.")
else:
    print(f"\n  ✗ Kelly fraction is negative - the game is not favorable long-term.")
